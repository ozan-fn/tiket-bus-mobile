        ...
        <>
            ...
            <SafeAreaView style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
                <View className="flex-1 px-6 pt-8">
                    ...
                    <Text className="text-3xl font-bold text-white mb-2">Login Account</Text>
                    <Text className="text-sm text-white/80 mb-10">Enter your credentials to continue and manage your trips seamlessly.</Text>

                    <View className="bg-white/90 dark:bg-white/10 border border-white/30 dark:border-white/10 rounded-4xl p-6 space-y-4 shadow-lg">
                        <View className="flex-row justify-between items-center">
                            <Text className="text-xs font-semibold tracking-[0.3em] text-slate-500">Welcome</Text>
                        ...
                        <View className="flex-row justify-between text-xs">
                            <TouchableOpacity>
                                <Text className="text-slate-500">Keep me logged in</Text>
                            </TouchableOpacity>
                            <TouchableOpacity>
                        ...
                        {loading ? (
                            ...
                            <TouchableOpacity onPress={handleLogin} className="w-full py-3 bg-blue-600 rounded-2xl shadow-lg">
                                <Text className="text-center text-white text-base font-semibold">Login</Text>
                            </TouchableOpacity>
                        )}
                    </View>

                    <TouchableOpacity className="mt-6" onPress={() => router.push("/register")}>
                        <Text className="text-center text-sm text-white/80">Don't have an account? Register</Text>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
        </>
