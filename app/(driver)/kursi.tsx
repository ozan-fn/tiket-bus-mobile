...
import { apiGetDriverSeats } from '@/lib/api';
...
export default function DriverSeatsScreen() {
  ...
  // Hardcode jadwalId untuk demo, bisa diganti dengan params
  const jadwalId = 2;
                    ...
                    <View className="gap-1">
                      ...
                      <Text className="text-sm">
                        ...
                        <Text className="font-medium">
                          {selectedSeat.penumpang.jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan'}
                        </Text>
                      </Text>
                      <Text className="text-sm">
                        <Text className="text-muted-foreground">Telepon: </Text>
                        <Text className="font-medium">{selectedSeat.penumpang.nomor_telepon}</Text>
                      </Text>
                      <Text className="text-sm">
