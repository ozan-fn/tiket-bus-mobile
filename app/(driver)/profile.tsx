    ...
    <ScrollView className="flex-1 bg-background">
      <View className="gap-6 p-6">
        ...
        <View className="gap-4 rounded-xl border border-border bg-card p-5 shadow-sm">
          <View className="items-center gap-4">
            {photo ? (
              <Image source={{ uri: photo }} className="size-24 rounded-full" />
            ) : (
          ...
          <View className="gap-3 rounded-xl border border-border bg-card p-4">
            ...
            <View className="flex-row items-center gap-3">
              ...
              <View className="flex-1">
                ...
                <Text className="font-medium capitalize">{userRole || 'Supir'}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View className="gap-3">
          ...
          <Button
            ...
            <View className="flex-1 items-start">
              <Text className="font-semibold">Edit Profil</Text>
      ...
      <AlertDialog open={showLogoutDialog} onOpenChange={setShowLogoutDialog}>
        <AlertDialogContent className="w-full max-w-md">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-center text-2xl">Konfirmasi Keluar</AlertDialogTitle>
