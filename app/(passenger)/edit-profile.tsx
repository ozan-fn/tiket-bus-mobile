        ...
        <View className="gap-6 p-6">
          ...
          <View className="gap-4">
            ...
            <View className="gap-2">
              ...
              <Input
                value={editData.nik}
                onChangeText={(value) => updateEditData('nik', value)}
            ...
            <View className="gap-2">
              ...
              <Input
                ...
                onChangeText={(value) => updateEditData('tanggal_lahir', value)}
            ...
            <View className="gap-2">
              ...
              <Select
                value={selectedGender as any}
                onValueChange={(option: any) => {
                  setSelectedGender(option);
                  updateEditData('jenis_kelamin', option?.value || '');
                }}>
                <SelectTrigger>
            ...
            <View className="gap-2">
              ...
              <Input
                ...
                onChangeText={(value) => updateEditData('nomor_telepon', value)}
